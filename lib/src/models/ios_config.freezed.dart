...
mixin _$IosConfig {
 ...
 bool get enabled; String get projectPath; String? get bundleId; String? get scheme; List<String> get buildArgs; TestflightConfig get testflight; AppStoreConfig get appStore;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is IosConfig&&(identical(other.enabled, enabled) || other.enabled == enabled)&&(identical(other.projectPath, projectPath) || other.projectPath == projectPath)&&(identical(other.bundleId, bundleId) || other.bundleId == bundleId)&&(identical(other.scheme, scheme) || other.scheme == scheme)&&const DeepCollectionEquality().equals(other.buildArgs, buildArgs)&&(identical(other.testflight, testflight) || other.testflight == testflight)&&(identical(other.appStore, appStore) || other.appStore == appStore));
}


@override
int get hashCode => Object.hash(runtimeType,enabled,projectPath,bundleId,scheme,const DeepCollectionEquality().hash(buildArgs),testflight,appStore);

@override
String toString() {
  return 'IosConfig(enabled: $enabled, projectPath: $projectPath, bundleId: $bundleId, scheme: $scheme, buildArgs: $buildArgs, testflight: $testflight, appStore: $appStore)';
}
...
@useResult
$Res call({
 bool enabled, String projectPath, String? bundleId, String? scheme, List<String> buildArgs, TestflightConfig testflight, AppStoreConfig appStore
});
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? enabled = null,Object? projectPath = null,Object? bundleId = freezed,Object? scheme = freezed,Object? buildArgs = null,Object? testflight = null,Object? appStore = null,}) {
...
as String?,buildArgs: null == buildArgs ? _self.buildArgs : buildArgs // ignore: cast_nullable_to_non_nullable
as List<String>,testflight: null == testflight ? _self.testflight : testflight // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( bool enabled,  String projectPath,  String? bundleId,  String? scheme,  List<String> buildArgs,  TestflightConfig testflight,  AppStoreConfig appStore)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.enabled,_that.projectPath,_that.bundleId,_that.scheme,_that.buildArgs,_that.testflight,_that.appStore);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( bool enabled,  String projectPath,  String? bundleId,  String? scheme,  List<String> buildArgs,  TestflightConfig testflight,  AppStoreConfig appStore)  $default,) {final _that = this;
switch (_that) {
case _IosConfig():
return $default(_that.enabled,_that.projectPath,_that.bundleId,_that.scheme,_that.buildArgs,_that.testflight,_that.appStore);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( bool enabled,  String projectPath,  String? bundleId,  String? scheme,  List<String> buildArgs,  TestflightConfig testflight,  AppStoreConfig appStore)?  $default,) {final _that = this;
switch (_that) {
case _IosConfig() when $default != null:
return $default(_that.enabled,_that.projectPath,_that.bundleId,_that.scheme,_that.buildArgs,_that.testflight,_that.appStore);case _:
  return null;
...
class _IosConfig implements IosConfig {
  const _IosConfig({this.enabled = true, this.projectPath = '.', this.bundleId, this.scheme, final  List<String> buildArgs = const <String>[], this.testflight = const TestflightConfig(), this.appStore = const AppStoreConfig()}): _buildArgs = buildArgs;
...
@override final  String? scheme;
 final  List<String> _buildArgs;
@override@JsonKey() List<String> get buildArgs {
  if (_buildArgs is EqualUnmodifiableListView) return _buildArgs;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_buildArgs);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IosConfig&&(identical(other.enabled, enabled) || other.enabled == enabled)&&(identical(other.projectPath, projectPath) || other.projectPath == projectPath)&&(identical(other.bundleId, bundleId) || other.bundleId == bundleId)&&(identical(other.scheme, scheme) || other.scheme == scheme)&&const DeepCollectionEquality().equals(other._buildArgs, _buildArgs)&&(identical(other.testflight, testflight) || other.testflight == testflight)&&(identical(other.appStore, appStore) || other.appStore == appStore));
}


@override
int get hashCode => Object.hash(runtimeType,enabled,projectPath,bundleId,scheme,const DeepCollectionEquality().hash(_buildArgs),testflight,appStore);
...
/// Create a copy of IosConfig
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? enabled = null,Object? projectPath = null,Object? bundleId = freezed,Object? scheme = freezed,Object? buildArgs = null,Object? testflight = null,Object? appStore = null,}) {
  return _then(_IosConfig(
enabled: null == enabled ? _self.enabled : enabled // ignore: cast_nullable_to_non_nullable
as bool,projectPath: null == projectPath ? _self.projectPath : projectPath // ignore: cast_nullable_to_non_nullable
as String,bundleId: freezed == bundleId ? _self.bundleId : bundleId // ignore: cast_nullable_to_non_nullable
as String?,scheme: freezed == scheme ? _self.scheme : scheme // ignore: cast_nullable_to_non_nullable
as String?,buildArgs: null == buildArgs ? _self._buildArgs : buildArgs // ignore: cast_nullable_to_non_nullable
as List<String>,testflight: null == testflight ? _self.testflight : testflight // ignore: cast_nullable_to_non_nullable
as TestflightConfig,appStore: null == appStore ? _self.appStore : appStore // ignore: cast_nullable_to_non_nullable
as AppStoreConfig,
  ));
