...
AppleBundleIdentifier bundle(String id, String identifier) =>
    AppleBundleIdentifier(id: id, identifier: identifier, platform: 'IOS');
...
void main() {
  test(
    ...
    () async {
      ...
      final client = FakeAppStoreConnectApi(
        signingCertificates: <AppleSigningCertificate>[certificate()],
        bundleIds: <AppleBundleIdentifier>[
  ...
  test('rejects a p12 certificate from another Apple developer team', () async {
    ...
    addTearDown(() => root.delete(recursive: true));
    final client = FakeAppStoreConnectApi(
      signingCertificates: <AppleSigningCertificate>[
